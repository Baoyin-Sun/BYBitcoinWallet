...
- (void)commonInit {
    ...
    self.opaque = NO;
    _selectionIndicatorColor = [UIColor by_colorWithHexString:c_darkSkyBlue];
    _bottomeLineColor = [UIColor by_colorWithHexString:c_whiteTwo_line];
...
- (void)updateSegmentsRects {
    ...
    if (self.isShowBottomLine) {
        ...
        self.bottomLineView.backgroundColor = self.bottomeLineColor;
        self.scrollView.frame = CGRectMake(0, 0, CGRectGetWidth(self.frame), CGRectGetHeight(self.frame)-self.bottomLineHeight);
    }
    else
    {
    ...
    self.scrollView.contentSize = CGSizeMake([self totalSegmentedControlWidth], self.isShowBottomLine?CGRectGetHeight(self.frame)-self.bottomLineHeight:self.frame.size.height);
}
...
- (NSDictionary *)resultingTitleTextAttributes {
    ...
    NSDictionary *defaults = @{
        NSFontAttributeName : [UIFont systemFontOfSize:by_autoResize(17)],
        NSForegroundColorAttributeName : [UIColor by_colorWithHexString:c_brownishGrey],
    };
...
- (NSDictionary *)resultingSelectedTitleTextAttributes {
    ...
    NSDictionary *defaults = @{
                               NSFontAttributeName : [UIFont systemFontOfSize:by_autoResize(17)],
                               NSForegroundColorAttributeName : [UIColor by_colorWithHexString:c_darkSkyBlue],
                               };
