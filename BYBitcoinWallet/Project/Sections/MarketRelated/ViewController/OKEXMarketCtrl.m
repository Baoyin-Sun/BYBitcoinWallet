...
#import "OKEXMarketCell.h"

@interface OKEXMarketCtrl () <UITableViewDelegate, UITableViewDataSource>
...
//        _tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
        ...
        [_tableView registerClass:[OKEXMarketCell class] forCellReuseIdentifier:BYClassName(OKEXMarketCell)];
...
- (HMSegmentedControl *) navigator {
    if (!_navigator) {
        NSArray *titles = @[@"合约", @"BTC", @"ETH", @"USDT", @"BCH"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    OKEXMarketCell *cell = [tableView dequeueReusableCellWithIdentifier:BYClassName(OKEXMarketCell) forIndexPath:indexPath];
    return cell;
}
